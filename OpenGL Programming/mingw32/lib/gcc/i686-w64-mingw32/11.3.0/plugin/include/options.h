...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 662,             /* -Wpedantic-ms-format */
  ...
  OPT_fset_stack_executable = 1442,          /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1617,      /* -fwritable-relocated-rdata */
  ...
  OPT_list = 1679,                           /* -list */
  OPT_m128bit_long_double = 1680,            /* -m128bit-long-double */
  OPT_m16 = 1681,                            /* -m16 */
  OPT_m32 = 1682,                            /* -m32 */
  OPT_m3dnow = 1683,                         /* -m3dnow */
  OPT_m3dnowa = 1684,                        /* -m3dnowa */
  OPT_m64 = 1685,                            /* -m64 */
  OPT_m80387 = 1686,                         /* -m80387 */
  OPT_m8bit_idiv = 1687,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1688,             /* -m96bit-long-double */
  OPT_mabi_ = 1689,                          /* -mabi= */
  OPT_mabm = 1690,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1691,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1692,                 /* -maddress-mode= */
  OPT_madx = 1693,                           /* -madx */
  OPT_maes = 1694,                           /* -maes */
  OPT_malign_data_ = 1695,                   /* -malign-data= */
  OPT_malign_double = 1696,                  /* -malign-double */
  OPT_malign_functions_ = 1697,              /* -malign-functions= */
  OPT_malign_jumps_ = 1698,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1699,                  /* -malign-loops= */
  OPT_malign_stringops = 1700,               /* -malign-stringops */
  OPT_mamx_bf16 = 1701,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1702,                      /* -mamx-int8 */
  OPT_mamx_tile = 1703,                      /* -mamx-tile */
  OPT_march_ = 1704,                         /* -march= */
  OPT_masm_ = 1705,                          /* -masm= */
  OPT_mavx = 1706,                           /* -mavx */
  OPT_mavx2 = 1707,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1708,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1709,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1710,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1711,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1712,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1713,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1714,                      /* -mavx512bw */
  OPT_mavx512cd = 1715,                      /* -mavx512cd */
  OPT_mavx512dq = 1716,                      /* -mavx512dq */
  OPT_mavx512er = 1717,                      /* -mavx512er */
  OPT_mavx512f = 1718,                       /* -mavx512f */
  OPT_mavx512ifma = 1719,                    /* -mavx512ifma */
  OPT_mavx512pf = 1720,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1721,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1722,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1723,                      /* -mavx512vl */
  OPT_mavx512vnni = 1724,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1725,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1726,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1727,                       /* -mavxvnni */
  OPT_mbmi = 1728,                           /* -mbmi */
  OPT_mbmi2 = 1729,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1730,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1731,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1732,                    /* -mcet-switch */
  OPT_mcld = 1733,                           /* -mcld */
  OPT_mcldemote = 1734,                      /* -mcldemote */
  OPT_mclflushopt = 1735,                    /* -mclflushopt */
  OPT_mclwb = 1736,                          /* -mclwb */
  OPT_mclzero = 1737,                        /* -mclzero */
  OPT_mcmodel_ = 1738,                       /* -mcmodel= */
  OPT_mconsole = 1739,                       /* -mconsole */
  /* OPT_mcpu_ = 1740, */                    /* -mcpu= */
  OPT_mcrc32 = 1741,                         /* -mcrc32 */
  OPT_mcx16 = 1742,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1743,            /* -mdispatch-scheduler */
  OPT_mdll = 1744,                           /* -mdll */
  OPT_mdump_tune_features = 1745,            /* -mdump-tune-features */
  OPT_menqcmd = 1746,                        /* -menqcmd */
  OPT_mf16c = 1747,                          /* -mf16c */
  OPT_mfancy_math_387 = 1748,                /* -mfancy-math-387 */
  OPT_mfentry = 1749,                        /* -mfentry */
  OPT_mfentry_name_ = 1750,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1751,               /* -mfentry-section= */
  OPT_mfma = 1752,                           /* -mfma */
  OPT_mfma4 = 1753,                          /* -mfma4 */
  OPT_mforce_drap = 1754,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1755,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1756,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1757,                       /* -mfpmath= */
  OPT_mfsgsbase = 1758,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1759,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1760, */              /* -mfused-madd */
  OPT_mfxsr = 1761,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1762,             /* -mgeneral-regs-only */
  OPT_mgfni = 1763,                          /* -mgfni */
  OPT_mhard_float = 1764,                    /* -mhard-float */
  OPT_mharden_sls_ = 1765,                   /* -mharden-sls= */
  OPT_mhle = 1766,                           /* -mhle */
  OPT_mhreset = 1767,                        /* -mhreset */
  OPT_miamcu = 1768,                         /* -miamcu */
  OPT_mieee_fp = 1769,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1770,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1771,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1772,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1773,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1774,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1775,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1776,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1777, */            /* -mintel-syntax */
  OPT_mkl = 1778,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1779,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1780,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1781,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1782,                /* -mlong-double-80 */
  OPT_mlwp = 1783,                           /* -mlwp */
  OPT_mlzcnt = 1784,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1785,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1786,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1787,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1788,                  /* -mmitigate-rop */
  OPT_mmmx = 1789,                           /* -mmmx */
  OPT_mmovbe = 1790,                         /* -mmovbe */
  OPT_mmovdir64b = 1791,                     /* -mmovdir64b */
  OPT_mmovdiri = 1792,                       /* -mmovdiri */
  OPT_mmpx = 1793,                           /* -mmpx */
  OPT_mms_bitfields = 1794,                  /* -mms-bitfields */
  OPT_mmwait = 1795,                         /* -mmwait */
  OPT_mmwaitx = 1796,                        /* -mmwaitx */
  OPT_mneeded = 1797,                        /* -mneeded */
  OPT_mno_align_stringops = 1798,            /* -mno-align-stringops */
  OPT_mno_default = 1799,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1800,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1801,                  /* -mno-push-args */
  OPT_mno_red_zone = 1802,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1803,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1804,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1805,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1806,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1807,                          /* -mpc32 */
  OPT_mpc64 = 1808,                          /* -mpc64 */
  OPT_mpc80 = 1809,                          /* -mpc80 */
  OPT_mpclmul = 1810,                        /* -mpclmul */
  OPT_mpcommit = 1811,                       /* -mpcommit */
  OPT_mpconfig = 1812,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1813,            /* -mpe-aligned-commons */
  OPT_mpku = 1814,                           /* -mpku */
  OPT_mpopcnt = 1815,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1816, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1817,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1818,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1819,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1820,                        /* -mprfchw */
  OPT_mptwrite = 1821,                       /* -mptwrite */
  OPT_mpush_args = 1822,                     /* -mpush-args */
  OPT_mrdpid = 1823,                         /* -mrdpid */
  OPT_mrdrnd = 1824,                         /* -mrdrnd */
  OPT_mrdseed = 1825,                        /* -mrdseed */
  OPT_mrecip = 1826,                         /* -mrecip */
  OPT_mrecip_ = 1827,                        /* -mrecip= */
  OPT_mrecord_mcount = 1828,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1829,                 /* -mrecord-return */
  OPT_mred_zone = 1830,                      /* -mred-zone */
  OPT_mregparm_ = 1831,                      /* -mregparm= */
  OPT_mrtd = 1832,                           /* -mrtd */
  OPT_mrtm = 1833,                           /* -mrtm */
  OPT_msahf = 1834,                          /* -msahf */
  OPT_mserialize = 1835,                     /* -mserialize */
  OPT_msgx = 1836,                           /* -msgx */
  OPT_msha = 1837,                           /* -msha */
  OPT_mshstk = 1838,                         /* -mshstk */
  OPT_mskip_rax_setup = 1839,                /* -mskip-rax-setup */
  OPT_msoft_float = 1840,                    /* -msoft-float */
  OPT_msse = 1841,                           /* -msse */
  OPT_msse2 = 1842,                          /* -msse2 */
  OPT_msse2avx = 1843,                       /* -msse2avx */
  OPT_msse3 = 1844,                          /* -msse3 */
  OPT_msse4 = 1845,                          /* -msse4 */
  OPT_msse4_1 = 1846,                        /* -msse4.1 */
  OPT_msse4_2 = 1847,                        /* -msse4.2 */
  OPT_msse4a = 1848,                         /* -msse4a */
  /* OPT_msse5 = 1849, */                    /* -msse5 */
  OPT_msseregparm = 1850,                    /* -msseregparm */
  OPT_mssse3 = 1851,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1852,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1853, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1854,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1855, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1856,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1857,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1858,            /* -mstringop-strategy= */
  OPT_mstv = 1859,                           /* -mstv */
  OPT_mtbm = 1860,                           /* -mtbm */
  OPT_mthreads = 1861,                       /* -mthreads */
  OPT_mtls_dialect_ = 1862,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1863,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1864,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1865,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1866,                         /* -mtune= */
  OPT_muintr = 1867,                         /* -muintr */
  OPT_municode = 1868,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1869,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1870,                          /* -mvaes */
  OPT_mveclibabi_ = 1871,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1872,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1873,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1874,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1875,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1876,                      /* -mwbnoinvd */
  OPT_mwidekl = 1877,                        /* -mwidekl */
  OPT_mwin32 = 1878,                         /* -mwin32 */
  OPT_mwindows = 1879,                       /* -mwindows */
  OPT_mx32 = 1880,                           /* -mx32 */
  OPT_mxop = 1881,                           /* -mxop */
  OPT_mxsave = 1882,                         /* -mxsave */
  OPT_mxsavec = 1883,                        /* -mxsavec */
  OPT_mxsaveopt = 1884,                      /* -mxsaveopt */
  OPT_mxsaves = 1885,                        /* -mxsaves */
  OPT_n = 1886,                              /* -n */
  OPT_name_sort = 1887,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1888,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1889,              /* -no-integrated-cpp */
  OPT_no_pie = 1890,                         /* -no-pie */
  OPT_no_pthread = 1891,                     /* -no-pthread */
  OPT_nocpp = 1892,                          /* -nocpp */
  OPT_nodefaultlibs = 1893,                  /* -nodefaultlibs */
  OPT_nolibc = 1894,                         /* -nolibc */
  OPT_nophoboslib = 1895,                    /* -nophoboslib */
  OPT_nostartfiles = 1896,                   /* -nostartfiles */
  OPT_nostdinc = 1897,                       /* -nostdinc */
  OPT_nostdinc__ = 1898,                     /* -nostdinc++ */
  OPT_nostdlib = 1899,                       /* -nostdlib */
  OPT_o = 1900,                              /* -o */
  OPT_objects = 1901,                        /* -objects */
  OPT_p = 1902,                              /* -p */
  OPT_pass_exit_codes = 1903,                /* -pass-exit-codes */
  /* OPT_pedantic = 1904, */                 /* -pedantic */
  OPT_pedantic_errors = 1905,                /* -pedantic-errors */
  OPT_pg = 1906,                             /* -pg */
  OPT_pie = 1907,                            /* -pie */
  OPT_pipe = 1908,                           /* -pipe */
  OPT_posix = 1909,                          /* -posix */
  OPT_print_file_name_ = 1910,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1911,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1912,          /* -print-multi-directory */
  OPT_print_multi_lib = 1913,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1914,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1915,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1916,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1917,               /* -print-prog-name= */
  OPT_print_search_dirs = 1918,              /* -print-search-dirs */
  OPT_print_sysroot = 1919,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1920,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1921,                    /* -print-value */
  OPT_pthread = 1922,                        /* -pthread */
  OPT_quiet = 1923,                          /* -quiet */
  OPT_r = 1924,                              /* -r */
  OPT_remap = 1925,                          /* -remap */
  OPT_reverse_sort = 1926,                   /* -reverse-sort */
  OPT_s = 1927,                              /* -s */
  OPT_save_temps = 1928,                     /* -save-temps */
  OPT_save_temps_ = 1929,                    /* -save-temps= */
  OPT_shared = 1930,                         /* -shared */
  OPT_shared_libgcc = 1931,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1932,               /* -shared-libphobos */
  OPT_size_sort = 1933,                      /* -size-sort */
  /* OPT_specs = 1934, */                    /* -specs */
  OPT_specs_ = 1935,                         /* -specs= */
  OPT_static = 1936,                         /* -static */
  OPT_static_libasan = 1937,                 /* -static-libasan */
  OPT_static_libgcc = 1938,                  /* -static-libgcc */
  OPT_static_libgfortran = 1939,             /* -static-libgfortran */
  OPT_static_libgo = 1940,                   /* -static-libgo */
  OPT_static_libhwasan = 1941,               /* -static-libhwasan */
  OPT_static_liblsan = 1942,                 /* -static-liblsan */
  OPT_static_libmpx = 1943,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1944,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1945,               /* -static-libphobos */
  OPT_static_libstdc__ = 1946,               /* -static-libstdc++ */
  OPT_static_libtsan = 1947,                 /* -static-libtsan */
  OPT_static_libubsan = 1948,                /* -static-libubsan */
  OPT_static_pie = 1949,                     /* -static-pie */
  /* OPT_std_c__03 = 1950, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1951, */                /* -std=c++0x */
  OPT_std_c__11 = 1952,                      /* -std=c++11 */
  OPT_std_c__14 = 1953,                      /* -std=c++14 */
  OPT_std_c__17 = 1954,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1955, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1956, */                /* -std=c++1z */
  OPT_std_c__20 = 1957,                      /* -std=c++20 */
  OPT_std_c__23 = 1958,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1959, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1960, */                /* -std=c++2b */
  OPT_std_c__98 = 1961,                      /* -std=c++98 */
  OPT_std_c11 = 1962,                        /* -std=c11 */
  OPT_std_c17 = 1963,                        /* -std=c17 */
  /* OPT_std_c18 = 1964, */                  /* -std=c18 */
  /* OPT_std_c1x = 1965, */                  /* -std=c1x */
  OPT_std_c2x = 1966,                        /* -std=c2x */
  /* OPT_std_c89 = 1967, */                  /* -std=c89 */
  OPT_std_c90 = 1968,                        /* -std=c90 */
  OPT_std_c99 = 1969,                        /* -std=c99 */
  /* OPT_std_c9x = 1970, */                  /* -std=c9x */
  OPT_std_f2003 = 1971,                      /* -std=f2003 */
  OPT_std_f2008 = 1972,                      /* -std=f2008 */
  OPT_std_f2008ts = 1973,                    /* -std=f2008ts */
  OPT_std_f2018 = 1974,                      /* -std=f2018 */
  OPT_std_f95 = 1975,                        /* -std=f95 */
  OPT_std_gnu = 1976,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1977, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1978, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1979,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1980,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1981,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1982, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1983, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1984,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1985,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1986, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1987, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1988,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1989,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1990,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1991, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1992, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1993,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1994, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1995,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1996,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1997, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1998, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1999,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2000, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2001, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2002, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2003, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2004, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2005,                     /* -std=legacy */
  OPT_stdlib_ = 2006,                        /* -stdlib= */
  OPT_symbol_ = 2007,                        /* -symbol= */
  OPT_symbolic = 2008,                       /* -symbolic */
  OPT_t = 2009,                              /* -t */
  OPT_time = 2010,                           /* -time */
  OPT_time_ = 2011,                          /* -time= */
  OPT_traditional = 2012,                    /* -traditional */
  OPT_traditional_cpp = 2013,                /* -traditional-cpp */
  OPT_tree_stats = 2014,                     /* -tree-stats */
  OPT_trigraphs = 2015,                      /* -trigraphs */
  OPT_type_stats = 2016,                     /* -type-stats */
  OPT_u = 2017,                              /* -u */
  OPT_undef = 2018,                          /* -undef */
  OPT_v = 2019,                              /* -v */
  OPT_version = 2020,                        /* -version */
  OPT_w = 2021,                              /* -w */
  OPT_wrapper = 2022,                        /* -wrapper */
  OPT_x = 2023,                              /* -x */
  OPT_z = 2024,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
